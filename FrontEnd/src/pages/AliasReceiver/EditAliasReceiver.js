  ...
  return (
    <>
      <Button color="success" onClick={modalToggle.setActive}>
        <span style={{ marginRight: "10px", paddingLeft: "20px", paddingRight: "20px" }}>Sửa</span>
        <FontAwesomeIcon icon={faEdit}></FontAwesomeIcon>
      </Button>

      <Modal isOpen={modalToggle.active} toggle={modalToggle.toggle}>
        <ModalHeader className="padding-header" toggle={modalToggle.toggle}>Sửa</ModalHeader>
        ...
        <ModalFooter className="padding-footer">
          <Button color="danger"
            ...
            onClick={editAlias}>
            <span style={{ padding: "0px 100px" }}>Sửa</span></Button>
          <Button color="light"
            className="d-flex align-items-center justify-content-center"
